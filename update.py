...
GITHUB_API_URL = "https://api.github.com/repos/ChocoMeow/Gana-Dashboard/releases/latest"
VOCARD_DASHBOARD_URL = "https://github.com/ChocoMeow/Gana-Dashboard/archive/"
...
def download_file(version=None):
    ...
    print(f"Downloading Gana Dashboard version: {version}")
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Update script for Gana Dashboard.')
    parser.add_argument('-c', '--check', action='store_true', help='Check the current version of the Gana Dashboard')
    parser.add_argument('-v', '--version', type=str, help='Install the specified version of the Gana Dashboard')
    parser.add_argument('-l', '--latest', action='store_true', help='Install the latest version of the Gana Dashboard from Github')
    parser.add_argument('-b', '--beta', action='store_true', help='Install the beta version of the Gana Dashboard from Github')
